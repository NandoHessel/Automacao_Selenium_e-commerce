...
public class CheckoutPage {
    ...
    private By btnconfirmaPedido = By.cssSelector("#payment-confirmation button");
    ...
    public PedidoPage clicarConfirmaPedido () {
        driver.findElement(btnconfirmaPedido).click();
